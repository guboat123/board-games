...
/* ไทยเขียนติดกัน นับคำด้วยช่องว่างจึงจับประโยคเต็มๆ ไม่ได้ ต้องมีเพดานความยาว */
["สีของมะม่วงสุกที่วางอยู่บนโต๊ะ", "ต้นไม้ที่อยู่หน้าบ้านของคุณยายมาก", "averyveryverylongenglishclue"]
  .forEach(c => t(c, 1, false, "ประโยคยาวติดกัน"));

/* คำเดี่ยวที่ยาวจริง ต้องไม่โดนบล็อก (นับเฉพาะอักษรฐาน) */
["ฟ้าทะลายโจร", "ประชาธิปไตย", "ก๋วยเตี๋ยว", "สับปะรด", "refrigerator"]
  .forEach(c => t(c, 1, true, "คำเดี่ยวยาวๆ"));
